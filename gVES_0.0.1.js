...
(function($) {
    ...
    function createCalendar() {
      ...
      request.execute(function(response) {
        ...
        console.log(test);
        calId=chooseRequestResponse.items[test].id;
      ...
      function chooseCalendar(){
        ...
        chooseRequest.execute(function(response){

        console.log(response.items);
        var test= prompt("enter number");
        console.log(test);
        calendarId=response.items[test].id;
       });
